...
{
	public class TimeLineHeaderFactory : AbstractTimeIntervalLabelFactory
	{
		...
		protected override void InitializeLabel( PositionedElement positioned, AxesIntervals<DateTime, TimeSpan, double, double> visible, Size panelSize )
		{
			...
			TimeLineHeader header = (TimeLineHeader)positioned.Element;
		...
		{
			TimeLineHeader header = (TimeLineHeader)label.Element;
